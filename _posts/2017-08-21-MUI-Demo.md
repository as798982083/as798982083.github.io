...
最简代码：  
    ...
    <script type="text/javascript"> 
	    ...
	    dtPicker.show(function (selectItems) { 
	    	var selected = selectItems.y.text + '-' + selectItems.m.text 
	    	+ '-' + selectItems.d.text + ' ' + selectItems.h.text
	    	+ ':' + selectItems.i.text;
	        console.log(selected);//{text: "2016",value: 2016} 
		}); 
			//console.log(dtPicker.getSelected()); 
	</script>        
